...
public class LoginActivity extends Activity implements View.OnClickListener,
        GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, Json.PostListener {
    ...
    protected void onStart() {
        ...
        if(getIntent().getExtras() != null && getIntent().getExtras().getBoolean("signout", false))
            logoutGp(this);
    }
